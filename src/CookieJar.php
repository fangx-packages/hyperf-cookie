...
use Fangx\Cookie\Contracts\QueueingFactory as JarContract;
...
class CookieJar implements JarContract
{
    ...
    public function make($name, $value, $minutes = 0, $path = null, $domain = null, $secure = null, $httpOnly = true, $raw = false, $sameSite = null)
    {
        ...
        return new Cookie((string)$name, (string)$value, (int)$time, (string)$path, (string)$domain, (bool)$secure, (bool)$httpOnly, (bool)$raw, $sameSite);
    }
